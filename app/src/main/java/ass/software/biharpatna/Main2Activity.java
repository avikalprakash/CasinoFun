                      ...
                      if (iNumber == 0) {
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  ...
                                  flag_value.setText(String.valueOf(0));
                              }
                          }, 20000);
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(1));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(2));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(3));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(4));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(5));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(6));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(7));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(8));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
                              public void LuckyRoundItemSelected(int index) {
                                  ...
                                  SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
                                  editor.putString("liveResult", String.valueOf(iNumber));
                                  editor.putInt("liveWheel", 4);
                                  editor.apply();
                          ...
                          new Handler().postDelayed(new Runnable(){
                              ...
                              public void run() {
                                  flag_image.setVisibility(View.VISIBLE);
                                  flag_value.setVisibility(View.VISIBLE);
                                  flag_value.setText(String.valueOf(9));
                              }
                          }, 20000);
                          luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
                              @Override
